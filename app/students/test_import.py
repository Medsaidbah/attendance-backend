...
from schemas import StudentImportRow, StudentImportResponse
...
class TestStudentImport:
    ...
    def test_validate_csv_row_empty_nom(self):
        ...
        with pytest.raises(ValueError, match="Le nom et prénom ne peuvent pas être vides"):
            StudentImportRow(**row_data)
    ...
    async def test_import_csv_valid_file(self):
        ...
        service.create_student = Mock(return_value={
            "id": 1,
            "matricule": "STU001",
            "nom": "Dupont",
            "prenom": "Jean",
    ...
    async def test_import_csv_duplicate_matricule(self):
        ...
        def mock_get_student(matricule):
            if matricule == "STU001":
                return {"id": 1, "matricule": "STU001", "nom": "Dupont", "prenom": "Jean"}
            return None
